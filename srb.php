...
<div class="navbar-LANGUAGE" id="navbar">
     <ul>
         <li class="nav-item" name="terkep"><a class="nav-link" href="map.php" >MAPA</a></li>
         <li class="nav-item" name="tanarokjelenlete"><a class="nav-link" href="teachers.php">PRISUSTVO NASTAVNIKA</a></li>
         <li class="nav-item" name="eref"><a class="nav-link" href="eref.php">EREF</a></li>
         <li class="nav-item" name="osztondij"><a class="nav-link" href="scholership.php">STIPENDIJE</a></li>
